...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push( function() {
	...
	_gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin","TweenLite"], function(TweenPlugin, TweenLite) {
		...
		//used by NoActionTo() for gathering all the style properties of each child element into an array for comparison.
		 ...
		 */
		CSSPlugin.NoActionTo = function(target, duration, vars) {
