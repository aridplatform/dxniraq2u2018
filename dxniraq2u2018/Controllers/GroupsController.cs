...
namespace dxniraq2u2018.Controllers
{
    public class GroupsController : Controller
    {
        ...
        public GroupsController(ApplicationDbContext context, UserManager<ApplicationUser> userMrg, IHostingEnvironment environment)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index()
        {
            ...
            {
                Communities = _context.Communities.Where(a => a.CommunityType == CommunityType.Group && (a.ApplicationUserId == _userManager.GetUserId(User))),
...
myfile1, _environment.WebRootPath, Properties.Resources.imgFolder, 50, 50);
                ...
                community.SecurityLevel = SecurityLevel.RequiresAdminApproval;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ApplicationUserId,Name,ShortName,BgImage,Logo,Description,CreationDate,CommunityType,SpecialityId,SecurityLevel,IsCommentsAllowed,IsFeatured,IsApproved,IsSuspended,Tags")] Community community)
        {
            if (id != community.Id)
            {
                return NotFound();
