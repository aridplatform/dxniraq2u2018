...
namespace dxniraq2u2018.Controllers
{
    public class PaymentMethodsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,MethodName,Description,IsActive")] PaymentMethod paymentMethod)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MethodName,Description,IsActive")] PaymentMethod paymentMethod)
        {
