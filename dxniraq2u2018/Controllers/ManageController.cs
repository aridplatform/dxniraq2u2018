...
using dxniraq2u2018.Models.ManageViewModels;
...
namespace dxniraq2u2018.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            ViewData["MemberTypeId"] = new SelectList(_context.MemberTypes, "Id", "TypeAbbreviation");
            ...
            var model = new IndexViewModel
            {
                ...
                Gender = user.Gender,
                InvitationLink = "https://dxniraq2u.com/Account/Register/?sid=" + user.DxnId
        ...
        public async Task<IActionResult> Index(IndexViewModel model, IFormFile myfile)
        {
            ...
            user.DxnId = model.DXNId;
                     user.Gender = model.Gender;
            user.Balance = 1;
            user.MemberTypeId = model.MemberTypeId;
            user.CityId = model.CityId;
            user.SponsorId = model.SponsorId;

            user.ProfileImage = await UserFile.UploadeNewImageAsync(user.ProfileImage,
              myfile, _environment.WebRootPath, Properties.Resources.imgFolder, 50, 50);

            await _userManager.UpdateAsync(user);
            //------------------------------------------

            StatusMessage = "تم تحديث تفاصيل الحساب بنجاح";
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("dxniraq2u2018"),
